        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('administration.settings.user.update', $user) }}" method="post" autocomplete="off" id="userEditForm">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @enderror
                                        <small class="text-muted">Minimum 8 characters (optional)</small>
                                    </div>
                                    <div class="col-md-6 mb-3">
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <p class="fw-semibold">
                                            <span class="badge {{ isset($user->status) && $user->status === 'Active' ? 'bg-success' : 'bg-danger' }}">
                                                {{ $user->status ?? 'Active' }}
                                            </span>
                                        </p>
                                    </div>
