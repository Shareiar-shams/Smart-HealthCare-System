...
@section('main_content')
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <p class="mb-0 text-muted">{{ $appointment->patient->name ?? 'Unknown Patient' }}</p>
                                        </div>
    ...
    <div class="modal fade show" id="confirmAppointmentModal" tabindex="-1">
    ...
    <div class="modal fade show" id="rejectAppointmentModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
    ...
    <script>
        $(document).ready(function() {
            ...
            function filterAppointments() {
                ...
                $.get('{{ route("administration.appointment.doctor.appointments") }}', {
                    search: search,
                    date: date
                }, function(data) {
        ...
        function confirmAppointment(id) {
            $('#confirmAppointmentForm').attr('action', `/appointment/${id}/confirm`);
            $('#confirmAppointmentModal').modal('show');
        }

        function rejectAppointment(id) {
            $('#rejectAppointmentForm').attr('action', `/appointment/${id}/reject`);
