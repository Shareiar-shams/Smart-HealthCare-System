    ...
    public static function getErrorData(int $statusCode): array
    {
        return match ($statusCode) {
            401 => [
                ...
                'image' => 'admin/assets/img/error/401.gif',
            ],
            403 => [
                'title' => 'Forbidden',
                'message' => 'You do not have permission to access this resource.',
                'image' => 'admin/assets/img/error/403.gif',
            ],
            404 => [
                'title' => 'Page Not Found',
                'message' => 'We\'re sorry, the page you requested could not be found.<br />
                            Please go back to the homepage.',
                'image' => 'admin/assets/img/error/404.gif',
            ],
            419 => [
                'title' => 'Page Expired',
                'message' => 'Page expired, please refresh and try again.',
                'image' => 'admin/assets/img/error/419.gif',
            ],
            500 => [
                'title' => 'Server Error',
                'message' => 'Something went wrong on our end.',
                'image' => 'admin/assets/img/error/500.gif',
            ],
            503 => [
                'title' => 'Maintenance Mode',
                'message' => 'We\`re currently performing scheduled maintenance to improve your experience.<br />
                            Please check back in a few minutes.',
                'image' => 'admin/assets/img/error/error_503.json',
                'view' => 'errors.503',
            ],
            default => [
                'title' => 'Unexpected Error',
                'message' => 'An error occurred. Please try again later.',
                'image' => 'admin/assets/img/error/default.gif',
            ],
        };
    }
